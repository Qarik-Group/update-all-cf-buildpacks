...
cflinuxfs3_buildpacks=$(cat <<-JSON
{
  ...
  "php_buildpack": "https://github.com/cloudfoundry/php-buildpack/releases/download/v4.4.29/php-buildpack-cflinuxfs3-v4.4.29.zip",
  ...
  "ruby_buildpack": "https://github.com/cloudfoundry/ruby-buildpack/releases/download/v1.8.29/ruby-buildpack-cflinuxfs3-v1.8.29.zip",
