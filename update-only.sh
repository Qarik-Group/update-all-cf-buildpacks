...
cflinuxfs3_buildpacks=$(cat <<-JSON
{
  ...
  "nodejs_buildpack": "https://github.com/cloudfoundry/nodejs-buildpack/releases/download/v1.7.37/nodejs-buildpack-cflinuxfs3-v1.7.37.zip",
  ...
  "staticfile_buildpack": "https://github.com/cloudfoundry/staticfile-buildpack/releases/download/v1.5.14/staticfile-buildpack-cflinuxfs3-v1.5.14.zip",
