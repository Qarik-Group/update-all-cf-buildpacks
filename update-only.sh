...
cflinuxfs3_buildpacks=$(cat <<-JSON
{
  ...
  "nodejs_buildpack": "https://github.com/cloudfoundry/nodejs-buildpack/releases/download/v1.7.11/nodejs-buildpack-cflinuxfs3-v1.7.11.zip",
  "php_buildpack": "https://github.com/cloudfoundry/php-buildpack/releases/download/v4.4.7/php-buildpack-cflinuxfs3-v4.4.7.zip",
  ...
  "ruby_buildpack": "https://github.com/cloudfoundry/ruby-buildpack/releases/download/v1.8.10/ruby-buildpack-cflinuxfs3-v1.8.10.zip",
