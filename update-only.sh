...
cflinuxfs3_buildpacks=$(cat <<-JSON
{
  ...
  "java_buildpack": "https://github.com/cloudfoundry/java-buildpack/releases/download/v4.33/java-buildpack-v4.33.zip",
  ...
  "nodejs_buildpack": "https://github.com/cloudfoundry/nodejs-buildpack/releases/download/v1.7.34/nodejs-buildpack-cflinuxfs3-v1.7.34.zip",
  "php_buildpack": "https://github.com/cloudfoundry/php-buildpack/releases/download/v4.4.24/php-buildpack-cflinuxfs3-v4.4.24.zip",
