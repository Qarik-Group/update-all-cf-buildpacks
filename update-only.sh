...
cflinuxfs3_buildpacks=$(cat <<-JSON
{
  ...
  "nodejs_buildpack": "https://github.com/cloudfoundry/nodejs-buildpack/releases/download/v1.7.74/nodejs-buildpack-cflinuxfs3-v1.7.74.zip",
  "php_buildpack": "https://github.com/cloudfoundry/php-buildpack/releases/download/v4.4.65/php-buildpack-cflinuxfs3-v4.4.65.zip",
  "python_buildpack": "https://github.com/cloudfoundry/python-buildpack/releases/download/v1.7.58/python-buildpack-cflinuxfs3-v1.7.58.zip",
