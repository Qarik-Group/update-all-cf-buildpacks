...
cflinuxfs3_buildpacks=$(cat <<-JSON
{
  ...
  "nginx_buildpack": "https://github.com/cloudfoundry/nginx-buildpack/releases/download/v1.1.12/nginx-buildpack-cflinuxfs3-v1.1.12.zip",
  ...
  "ruby_buildpack": "https://github.com/cloudfoundry/ruby-buildpack/releases/download/v1.8.22/ruby-buildpack-cflinuxfs3-v1.8.22.zip",
