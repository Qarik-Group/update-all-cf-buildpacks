...
cflinuxfs3_buildpacks=$(cat <<-JSON
{
  ...
  "dotnet_core_buildpack": "https://github.com/cloudfoundry/dotnet-core-buildpack/releases/download/v2.3.25/dotnet-core-buildpack-cflinuxfs3-v2.3.25.zip",
  "go_buildpack": "https://github.com/cloudfoundry/go-buildpack/releases/download/v1.9.28/go-buildpack-cflinuxfs3-v1.9.28.zip",
  "java_buildpack": "https://github.com/cloudfoundry/java-buildpack/releases/download/v4.36/java-buildpack-v4.36.zip",
  "nginx_buildpack": "https://github.com/cloudfoundry/nginx-buildpack/releases/download/v1.1.23/nginx-buildpack-cflinuxfs3-v1.1.23.zip",
  "nodejs_buildpack": "https://github.com/cloudfoundry/nodejs-buildpack/releases/download/v1.7.46/nodejs-buildpack-cflinuxfs3-v1.7.46.zip",
  "php_buildpack": "https://github.com/cloudfoundry/php-buildpack/releases/download/v4.4.34/php-buildpack-cflinuxfs3-v4.4.34.zip",
  "python_buildpack": "https://github.com/cloudfoundry/python-buildpack/releases/download/v1.7.35/python-buildpack-cflinuxfs3-v1.7.35.zip",
  "r_buildpack": "https://github.com/cloudfoundry/r-buildpack/releases/download/v1.1.16/r-buildpack-cflinuxfs3-v1.1.16.zip",
  "ruby_buildpack": "https://github.com/cloudfoundry/ruby-buildpack/releases/download/v1.8.36/ruby-buildpack-cflinuxfs3-v1.8.36.zip",
  "staticfile_buildpack": "https://github.com/cloudfoundry/staticfile-buildpack/releases/download/v1.5.18/staticfile-buildpack-cflinuxfs3-v1.5.18.zip",
