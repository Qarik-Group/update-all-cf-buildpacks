...
cflinuxfs3_buildpacks=$(cat <<-JSON
{
  ...
  "dotnet_core_buildpack": "https://github.com/cloudfoundry/dotnet-core-buildpack/releases/download/v2.3.11/dotnet-core-buildpack-cflinuxfs3-v2.3.11.zip",
  "go_buildpack": "https://github.com/cloudfoundry/go-buildpack/releases/download/v1.9.14/go-buildpack-cflinuxfs3-v1.9.14.zip",
  "java_buildpack": "https://github.com/cloudfoundry/java-buildpack/releases/download/v4.31.1/java-buildpack-v4.31.1.zip",
  "nginx_buildpack": "https://github.com/cloudfoundry/nginx-buildpack/releases/download/v1.1.10/nginx-buildpack-cflinuxfs3-v1.1.10.zip",
  "nodejs_buildpack": "https://github.com/cloudfoundry/nodejs-buildpack/releases/download/v1.7.22/nodejs-buildpack-cflinuxfs3-v1.7.22.zip",
  "php_buildpack": "https://github.com/cloudfoundry/php-buildpack/releases/download/v4.4.16/php-buildpack-cflinuxfs3-v4.4.16.zip",
  "python_buildpack": "https://github.com/cloudfoundry/python-buildpack/releases/download/v1.7.15/python-buildpack-cflinuxfs3-v1.7.15.zip",
  "r_buildpack": "https://github.com/cloudfoundry/r-buildpack/releases/download/v1.1.6/r-buildpack-cflinuxfs3-v1.1.6.zip",
  "ruby_buildpack": "https://github.com/cloudfoundry/ruby-buildpack/releases/download/v1.8.20/ruby-buildpack-cflinuxfs3-v1.8.20.zip",
  "staticfile_buildpack": "https://github.com/cloudfoundry/staticfile-buildpack/releases/download/v1.5.7/staticfile-buildpack-cflinuxfs3-v1.5.7.zip",
