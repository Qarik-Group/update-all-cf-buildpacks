...
cflinuxfs3_buildpacks=$(cat <<-JSON
{
  ...
  "java_buildpack": "https://github.com/cloudfoundry/java-buildpack/releases/download/v4.46/java-buildpack-v4.46.zip",
  ...
  "php_buildpack": "https://github.com/cloudfoundry/php-buildpack/releases/download/v4.4.53/php-buildpack-cflinuxfs3-v4.4.53.zip",
