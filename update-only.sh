...
cflinuxfs3_buildpacks=$(cat <<-JSON
{
  ...
  "go_buildpack": "https://github.com/cloudfoundry/go-buildpack/releases/download/v1.9.43/go-buildpack-cflinuxfs3-v1.9.43.zip",
  ...
  "php_buildpack": "https://github.com/cloudfoundry/php-buildpack/releases/download/v4.4.60/php-buildpack-cflinuxfs3-v4.4.60.zip",
