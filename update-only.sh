...
cflinuxfs3_buildpacks=$(cat <<-JSON
{
  ...
  "nodejs_buildpack": "https://github.com/cloudfoundry/nodejs-buildpack/releases/download/v1.7.28/nodejs-buildpack-cflinuxfs3-v1.7.28.zip",
  ...
  "r_buildpack": "https://github.com/cloudfoundry/r-buildpack/releases/download/v1.1.8/r-buildpack-cflinuxfs3-v1.1.8.zip",
