...
{
  "binary_buildpack": "https://github.com/cloudfoundry/binary-buildpack/releases/download/v1.0.43/binary-buildpack-cflinuxfs3-v1.0.43.zip",
  ...
  "go_buildpack": "https://github.com/cloudfoundry/go-buildpack/releases/download/v1.9.42/go-buildpack-cflinuxfs3-v1.9.42.zip",
  ...
  "php_buildpack": "https://github.com/cloudfoundry/php-buildpack/releases/download/v4.4.59/php-buildpack-cflinuxfs3-v4.4.59.zip",
