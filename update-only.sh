...
cflinuxfs3_buildpacks=$(cat <<-JSON
{
  ...
  "nginx_buildpack": "https://github.com/cloudfoundry/nginx-buildpack/releases/download/v1.1.35/nginx-buildpack-cflinuxfs3-v1.1.35.zip",
  ...
  "php_buildpack": "https://github.com/cloudfoundry/php-buildpack/releases/download/v4.4.56/php-buildpack-cflinuxfs3-v4.4.56.zip",
  ...
  "r_buildpack": "https://github.com/cloudfoundry/r-buildpack/releases/download/v1.1.26/r-buildpack-cflinuxfs3-v1.1.26.zip",
