...
cflinuxfs3_buildpacks=$(cat <<-JSON
{
  ...
  "dotnet_core_buildpack": "https://github.com/cloudfoundry/dotnet-core-buildpack/releases/download/v2.4.4/dotnet-core-buildpack-cflinuxfs3-v2.4.4.zip",
  "go_buildpack": "https://github.com/cloudfoundry/go-buildpack/releases/download/v1.10.1/go-buildpack-cflinuxfs3-v1.10.1.zip",
  ...
  "php_buildpack": "https://github.com/cloudfoundry/php-buildpack/releases/download/v4.4.68/php-buildpack-cflinuxfs3-v4.4.68.zip",
  "python_buildpack": "https://github.com/cloudfoundry/python-buildpack/releases/download/v1.8.3/python-buildpack-cflinuxfs3-v1.8.3.zip",
  "r_buildpack": "https://github.com/cloudfoundry/r-buildpack/releases/download/v1.1.35/r-buildpack-cflinuxfs3-v1.1.35.zip",
  "ruby_buildpack": "https://github.com/cloudfoundry/ruby-buildpack/releases/download/v1.8.60/ruby-buildpack-cflinuxfs3-v1.8.60.zip",
