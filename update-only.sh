...
cflinuxfs3_buildpacks=$(cat <<-JSON
{
  ...
  "go_buildpack": "https://github.com/cloudfoundry/go-buildpack/releases/download/v1.9.8/go-buildpack-cflinuxfs3-v1.9.8.zip",
  ...
  "php_buildpack": "https://github.com/cloudfoundry/php-buildpack/releases/download/v4.4.9/php-buildpack-cflinuxfs3-v4.4.9.zip",
