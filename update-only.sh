...
{
  "binary_buildpack": "https://github.com/cloudfoundry/binary-buildpack/releases/download/v1.0.46/binary-buildpack-cflinuxfs3-v1.0.46.zip",
  ...
  "go_buildpack": "https://github.com/cloudfoundry/go-buildpack/releases/download/v1.9.49/go-buildpack-cflinuxfs3-v1.9.49.zip",
  "java_buildpack": "https://github.com/cloudfoundry/java-buildpack/releases/download/v4.51/java-buildpack-v4.51.zip",
  "nginx_buildpack": "https://github.com/cloudfoundry/nginx-buildpack/releases/download/v1.1.43/nginx-buildpack-cflinuxfs3-v1.1.43.zip",
  "nodejs_buildpack": "https://github.com/cloudfoundry/nodejs-buildpack/releases/download/v1.8.0/nodejs-buildpack-cflinuxfs3-v1.8.0.zip",
  "php_buildpack": "https://github.com/cloudfoundry/php-buildpack/releases/download/v4.4.66/php-buildpack-cflinuxfs3-v4.4.66.zip",
  "python_buildpack": "https://github.com/cloudfoundry/python-buildpack/releases/download/v1.7.59/python-buildpack-cflinuxfs3-v1.7.59.zip",
