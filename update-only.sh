...
cflinuxfs3_buildpacks=$(cat <<-JSON
{
  ...
  "nginx_buildpack": "https://github.com/cloudfoundry/nginx-buildpack/releases/download/v1.1.22/nginx-buildpack-cflinuxfs3-v1.1.22.zip",
  ...
  "r_buildpack": "https://github.com/cloudfoundry/r-buildpack/releases/download/v1.1.15/r-buildpack-cflinuxfs3-v1.1.15.zip",
  ...
  "staticfile_buildpack": "https://github.com/cloudfoundry/staticfile-buildpack/releases/download/v1.5.17/staticfile-buildpack-cflinuxfs3-v1.5.17.zip",
